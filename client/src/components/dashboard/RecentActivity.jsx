      ...
      {tasks.length === 0 ? (
        ...
        <div className="space-y-5">
          {tasks.map((task) => {
            ...
            return (
              <motion.div key={task._id} whileHover={{ x: 5 }} className="flex gap-3 sm:gap-4">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-orange-100 text-orange-600 sm:h-12 sm:w-12">
                  <Icon />
                </div>
                ...
                <div className="flex-1 border-b border-gray-100 pb-4">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 break-words text-sm text-gray-500">{task.title}</p>
                    </div>
